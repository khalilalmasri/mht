  ...
  return (
    <div className=" sm:flex-row  flex flex-col-reverse  items-center mx-4 sm:mx-12 min-h-[360] my-20  ">
      <div className="sm:w-1/2 ">
        <h2 className= {`text-[16px] sm:text-2xl   mt-4  mb-1 text-center sm:text-start ${i18n.language === 'ar' ? 'riyadBank' : 'SamsungOne-bold' }`}>
          {t("desc.Access_to_a_Global_Client_Base")}
        </h2>
        <p className={` text-[12px] sm:text-[18px] text-center sm:text-start mt-2 text-[#4f4f4f] sm:pe-20 ${i18n.language === 'ar' ? 'riyadBank' : '' }`} >
