  ...
  return (
    <div className="  mx-4 sm:mx-12 mt-20 sm:mt-40">
      ...
      <div className="w-full h-[30px] sm:h-[50px] bg-[#0e9c95] rounded-t-2xl p-2">
        <p className=" fontAbsolute text-white text-2xl sm:text-5xl  sm:ms-16 tracking-[0.1em] ">
          Is coming soon
        </p>
        <div></div>
      </div>
      <div className="w-full h-auto  bg-[#7cfcf6] flex  p-2 text-center justify-center">
        <div className=" sm:w-1/2 flex-col">
          ...
          <p className=" text-white mt-10 sm:mt-14 text-2xl sm:text-5xl  fontAbsolute  tracking-[0.1em] ">
