  ...
  return (
    <div className="sm:flex   items-center  sm:mx-12 min-h-[400px] my-20 ">
      <div className="sm:w-1/2 ">
        <Image className="w-full h-full pe-6" src={budget} alt="" />
      </div>
      <div className="sm:w-1/2  ">
        <div className="flex">
          {" "}
          <p className=" sm:text-5xl fontAbsolute  text-[#74f6d7] ps-20 mb-1">
            Simplify{" "}
          </p>
          <p className=" text-3xl ms-1  mt-[20px]">budgeting and manage </p>
        </div>
        <p className="ps-20 text-3xl mt-[-10px]">with transparency</p>
