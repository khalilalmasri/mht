...
function IndependenceBusiness() {
  return (
    <><div className=" hidden sm:block bg-[#c9feff] my-6 ms-3 me-3 sm:me-16 sm:ms-12 text-[24px] rounded-2xl text-[#040404]  ">
  ...
  <div className=" flex flex-col sm:hidden  bg-[#c9feff] my-6 ms-3 me-3  text-[24px] rounded-2xl text-[#040404]">
      <div className=" ms-6 mt-8 ">
        <h2 className=" fontAbsolute  text-3xl font-extrabold text-[#49daf9]">
          hire
        </h2>
        <p className=" SamsungOne-bold sm:text-3xl text-[14px]  text-[#0404040] me-4  mb-1 ">
          the best freelance talent in the MENA region
        </p>
